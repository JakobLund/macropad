...
from utils.commands import Command, HwInfoRefreshException
...
class Key:
    ...
    class BoundKey:
        ...
        def label(self) -> str:
            ...
            """
            return self.app.display_group[self.key_number].text
...
class HwInfoKey(Key):
    ...
    def text(self, app) -> str:
        return self._text_template.format(value=self._text)
